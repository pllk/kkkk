...
\path[draw=red,thick,->,line width=2pt] (4) -- (7);
\path[draw=red,thick,->,line width=2pt] (4) -- (8);
\path[draw=red,thick,->,line width=2pt] (4) -- (9);

\node[color=red] at (0,3+0.65) {1};
\node[color=red] at (-3-0.65,1) {2};
\node[color=red] at (-1-0.65,1) {4};
\node[color=red] at (1+0.65,1) {5};
\node[color=red] at (3+0.65,1) {9};
\node[color=red] at (-3,-1-0.65) {3};
\node[color=red] at (-0.5,-1-0.65) {6};
\node[color=red] at (1,-1-0.65) {7};
\node[color=red] at (2.5,-1-0.65) {8};
\end{tikzpicture}
\end{center}
