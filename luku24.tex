...
Nyt joukkoa $A$ vastaavan tapahtuman
...
\index{ehdollinen todennäköisyys}
...
\index{tasajakauma}
~\\
\textit{Tasajakauman} satunnaismuuttuja
...
\index{binomijakauma}
~\\
\textit{Binomijakauma} kuvaa tilannetta, jossa tehdään $n$
...
\[E[X] = pn.\]
\index{geometrinen jakauma}
~\\
\textit{Geometrinen jakauma} kuvaa tilannetta,
