...
\node[draw, circle] (4) at (4,1) {$\infty$};
...
Algoritmin toiminta muodostuu peräkkäisistä
kierroksista.
Jokaisella kierroksella algoritmi käy kaikki
verkon kaaret läpi.
Jos kaaren avulla pystyy parantamaan jotain
etäisyysarviota, algoritmi tekee näin.

Tässä verkossa ensimmäinen kierros
parantaa arvioita näin:
\begin{center}
\begin{tikzpicture}
\node[draw, circle] (1) at (1,3) {$0$};
\node[draw, circle] (2) at (4,3) {$2$};
\node[draw, circle] (3) at (1,1) {$3$};
\node[draw, circle] (4) at (4,1) {$7$};
\node[draw, circle] (5) at (6,2) {$\infty$};
\path[draw,thick,-] (1) -- node[font=\small,label=above:2] {} (2);
\path[draw,thick,-] (1) -- node[font=\small,label=left:3] {} (3);
\path[draw,thick,-] (3) -- node[font=\small,label=below:$-2$] {} (4);
...
Esimerkiksi alkusolmusta lähtevä 2:n pituinen
kaari parantaa kohdesolmun etäisyysarviota,
koska vanha arvio oli ääretön,
mutta kulkemalla tätä kaarta alkusolmusta
etäisyys on vain 2.
...
%\path[draw=gray,thick,->,line width=2pt] (1) -- (2);
%\path[draw=gray,thick,->,line width=2pt] (1) -- (3);
...
oikeanpuolimmaiseen solmuun toteutuu
käyttämällä seuraavaa reittiä:
\begin{center}
\begin{tikzpicture}
\node[draw, circle] (1) at (1,3) {$0$};
\node[draw, circle] (2) at (4,3) {$2$};
