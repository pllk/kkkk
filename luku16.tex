...
Tarkastellaan esimerkkinä seuraavaa tuttua tehtävää:
...
Tehtävästä voidaan muodostaa verkko, jossa solmut
kuvaavat rahamääriä ja kaaret kuvaavat
valittavia kolikoita.
...
\index{seuraajaverkko}
\index{funktionaalinen verkko}

Seuraavaksi oletamme, että
suunnaton verkko on \textit{seuraajaverkko},
...
Seuraajaverkosta käytetään joskus myös nimeä
\textit{funktionaalinen verkko}.
...
Tunnetuin tällainen algoritmi on
\textit{Floydin algoritmi}, johon tutustumme seuraavaksi.

\subsubsection{Floydin algoritmi}

\index{Floydin algoritmi}
