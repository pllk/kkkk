...
Pelin tilan Grundy-luku määritellään seuraavasti:
\begin{itemize}[noitemsep]
\item jos tilasta ei voi tehdä mitään siirtoa,
sen Grundy-luku on 0
\item muuten Grundy-luku on pienin ei-negatiivinen kokonaisluku,
joka ei ole sellaisen tilan Grundy-luku,
