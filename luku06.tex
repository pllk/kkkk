...
ja jokaista kolikkoa saatavilla rajattomasti.
...
$\{20,100,200,200\}$, joiden summa on 520.
...
\emph{pakata} merkkijono niin,
että se vie vähemmän tilaa.
...
Osoittautuu, että yllä olevaa merkkijonoa
silmällä pitäen \key{optimaalinen} koodi on seuraava:
\begin{center}
\begin{tabular}{rr}
merkki & koodisana \\
\hline
...
perustella binääripuun, josta voidaan lukea
