...
Syvyyshaku (\textit{depth-first search} eli \textit{DFS})
...
Leveyshaku (\textit{breadth-first search} eli \textit{BFS})
...
Suuntaamattomassa verkossa on sykli,
jos jonkin komponentin läpikäynnin aikana tulee vastaan solmu,
...
havaitaan, että solmu 3 on jo käsitelty.
