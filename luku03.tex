...
aikaa $O(n \log n)$.
Tunnetuimmat tällaiset algoritmit ovat
\key{lomitusjärjestäminen} ja
\key{pikajärjestäminen},
jotka molemmat järjestävät taulukon
rekursiivisesti jakamalla sen
pienemmiksi osataulukoiksi.
Tutustumme seuraavaksi tarkemmin
lomitusjärjestämiseen.
